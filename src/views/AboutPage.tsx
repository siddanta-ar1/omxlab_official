...
const floatingIcons = [
    { id: 1, Icon: LuBuilding2, color: 'text-[#4F46E5]', pos: 'top-[15%] left-[4%]', size: 'text-5xl', animation: 'animate-float' },
    { id: 2, Icon: LuCompass, color: 'text-[#0891B2]', pos: 'top-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 3, Icon: LuTarget, color: 'text-[#2563EB]', pos: 'bottom-[30%] left-[5%]', size: 'text-5xl', animation: 'animate-float-slow' },
    { id: 4, Icon: LuUsers, color: 'text-[#4F46E5]', pos: 'top-[20%] right-[5%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 5, Icon: LuAward, color: 'text-[#0284C7]', pos: 'top-[45%] right-[7%]', size: 'text-4xl', animation: 'animate-float' },
    { id: 6, Icon: LuHandshake, color: 'text-[#0891B2]', pos: 'bottom-[25%] right-[5%]', size: 'text-3xl', animation: 'animate-float-slow' },
];

const mobileFloatingIcons = [
    { id: 1, Icon: LuBuilding2, color: 'text-[#4F46E5]', pos: 'top-[12%] left-[4%]', size: 'text-3xl', animation: 'animate-float-fast' },
    { id: 2, Icon: LuUsers, color: 'text-[#4F46E5]', pos: 'top-[30%] right-[4%]', size: 'text-3xl', animation: 'animate-float-fast-delayed' },
    { id: 3, Icon: LuTarget, color: 'text-[#2563EB]', pos: 'bottom-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-fast-slow' },
    { id: 4, Icon: LuAward, color: 'text-[#0284C7]', pos: 'bottom-[22%] right-[6%]', size: 'text-3xl', animation: 'animate-float-fast' },
];
        ...
        <>
            <section className="relative overflow-hidden flex items-center justify-center bg-[var(--color-surface)] border-b border-[var(--color-border)]">
                ...
                <div className="relative z-20 max-w-4xl mx-auto px-6 lg:px-8 py-24 lg:py-28 flex flex-col items-center text-center gap-8">
                    ...
                    <div className="mt-8 relative rounded-[4px] overflow-hidden border border-[var(--color-border)] group w-full max-w-3xl">
