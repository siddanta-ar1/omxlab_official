...
const floatingIcons = [
    ...
    { id: 3, Icon: LuGraduationCap, color: 'text-[#C4B5FD]', pos: 'bottom-[30%] left-[12%]', size: 'text-5xl', animation: 'animate-float-slow' },
    { id: 4, Icon: LuAward, color: 'text-[#8B5CF6]', pos: 'top-[20%] right-[15%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 5, Icon: LuCompass, color: 'text-[#A78BFA]', pos: 'top-[45%] right-[28%]', size: 'text-4xl', animation: 'animate-float' },
...
const mobileFloatingIcons = [
    ...
    { id: 3, Icon: LuGraduationCap, color: 'text-[#C4B5FD]', pos: 'bottom-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-fast-slow' },
    { id: 4, Icon: LuCompass, color: 'text-[#A78BFA]', pos: 'bottom-[22%] right-[6%]', size: 'text-3xl', animation: 'animate-float-fast' },
];
