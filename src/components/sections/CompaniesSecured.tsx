        ...
        <section className="bg-surface py-24 overflow-hidden font-sans border-b border-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-secondary mb-4 tracking-tight">
                    Top Companies <span className="text-[#4F46E5]">We Secured</span>
                </h2>
                ...
                <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-[3px] border border-border bg-surface text-xs font-bold text-muted tracking-wider mb-16 shadow-sm">
                    <span className="w-2 h-2 rounded-full bg-[#94A3B8]" />
                    300+ ORGANIZATIONS <span className="text-muted mx-1">•</span> HALL OF FAME
                </div>
            ...
            <div className="relative w-full overflow-hidden flex [mask-image:_linear-gradient(to_right,_transparent_0,_black_10%,_black_90%,_transparent_100%)]">
                <div className="flex gap-4 items-center whitespace-nowrap animate-marquee py-4">
                    ...
                    {[...securedOrganizations, ...securedOrganizations, ...securedOrganizations].map((org, index) => (
                        <div 
                            key={index} 
                            className="flex items-center gap-3 px-5 py-3 bg-surface border border-border rounded-[3px] shadow-sm hover:-translate-y-0.5 transition-all cursor-pointer"
                        >
                            <span className="text-xl bg-surface w-8 h-8 flex items-center justify-center rounded-[2px] border border-border">{org.icon}</span>
