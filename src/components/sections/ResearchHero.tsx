...
const floatingIcons = [
    { id: 1, Icon: LuFlaskConical, color: 'text-[#0ea5e9]', pos: 'top-[15%] left-[10%]', size: 'text-5xl', animation: 'animate-float' },
    { id: 2, Icon: LuMicroscope, color: 'text-[#8b5cf6]', pos: 'top-[35%] left-[25%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 3, Icon: LuBrainCircuit, color: 'text-[#ec4899]', pos: 'bottom-[30%] left-[12%]', size: 'text-5xl', animation: 'animate-float-slow' },
    { id: 4, Icon: LuBookOpen, color: 'text-[#f59e0b]', pos: 'top-[20%] right-[15%]', size: 'text-5xl', animation: 'animate-float-delayed' },
    { id: 5, Icon: LuTelescope, color: 'text-[#10b981]', pos: 'top-[45%] right-[28%]', size: 'text-4xl', animation: 'animate-float' },
...
const mobileFloatingIcons = [
    { id: 1, Icon: LuFlaskConical, color: 'text-[#0ea5e9]', pos: 'top-[12%] left-[4%]', size: 'text-3xl', animation: 'animate-float-fast' },
    { id: 2, Icon: LuTelescope, color: 'text-[#10b981]', pos: 'top-[30%] right-[4%]', size: 'text-3xl', animation: 'animate-float-fast-delayed' },
    { id: 3, Icon: LuBrainCircuit, color: 'text-[#ec4899]', pos: 'bottom-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-fast-slow' },
    { id: 4, Icon: LuBookOpen, color: 'text-[#f59e0b]', pos: 'bottom-[22%] right-[6%]', size: 'text-3xl', animation: 'animate-float-fast' },
];
