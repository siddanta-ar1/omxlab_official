...
const floatingIcons = [
    { id: 1, Icon: LuFlaskConical, color: 'text-[#0284C7]', pos: 'top-[15%] left-[4%]', size: 'text-5xl', animation: 'animate-float' },
    { id: 2, Icon: LuMicroscope, color: 'text-[#4F46E5]', pos: 'top-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 3, Icon: LuBrainCircuit, color: 'text-[#2563EB]', pos: 'bottom-[30%] left-[5%]', size: 'text-5xl', animation: 'animate-float-slow' },
    { id: 4, Icon: LuBookOpen, color: 'text-[#0284C7]', pos: 'top-[20%] right-[5%]', size: 'text-5xl', animation: 'animate-float-delayed' },
    { id: 5, Icon: LuTelescope, color: 'text-[#94A3B8]', pos: 'top-[45%] right-[7%]', size: 'text-4xl', animation: 'animate-float' },
    { id: 6, Icon: LuLightbulb, color: 'text-[#eab308]', pos: 'bottom-[25%] right-[5%]', size: 'text-4xl', animation: 'animate-float-slow' },
];

const mobileFloatingIcons = [
    { id: 1, Icon: LuFlaskConical, color: 'text-[#0284C7]', pos: 'top-[12%] left-[4%]', size: 'text-3xl', animation: 'animate-float-fast' },
    { id: 2, Icon: LuTelescope, color: 'text-[#94A3B8]', pos: 'top-[30%] right-[4%]', size: 'text-3xl', animation: 'animate-float-fast-delayed' },
    { id: 3, Icon: LuBrainCircuit, color: 'text-[#2563EB]', pos: 'bottom-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-fast-slow' },
    { id: 4, Icon: LuBookOpen, color: 'text-[#0284C7]', pos: 'bottom-[22%] right-[6%]', size: 'text-3xl', animation: 'animate-float-fast' },
];
