        ...
        >
            ...
            <div className={`w-full md:w-[45%] pl-16 md:pl-0 pt-0 ${textAlignment}`}>
                <div 
                    ...
                    className={`bg-surface p-6 md:p-8 rounded-[4px] border border-[var(--color-border)] shadow-sm hover:shadow-[0_15px_40px_-10px_rgba(0,0,0,0.5)] hover:-translate-y-1 transition-all duration-1000 ${
                        isVisible 
