...
const areas = [
    {
        ...
        icon: <LuCpu className="w-7 h-7 text-[#0891B2]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuBrainCircuit className="w-7 h-7 text-[#0284C7]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuNetwork className="w-7 h-7 text-[#2563EB]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuShieldAlert className="w-7 h-7 text-[#4F46E5]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuActivity className="w-7 h-7 text-[#2563EB]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuUsers className="w-7 h-7 text-[#4F46E5]" strokeWidth={2} />,
    },
];
        ...
        <section className="bg-[var(--color-body)] py-16 md:py-20 border-t border-[var(--color-border)]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[var(--color-secondary)] tracking-tight mb-6">
                    Six threads we <span className="text-[var(--color-primary-ink)]">keep pulling on.</span>
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 border-t border-l border-[var(--color-border)]">
                    {areas.map((area) => (
                        <Link
                            ...
                            className="group bg-[var(--color-surface)] border-r border-b border-[var(--color-border)] p-8 transition-all duration-300 ease-out hover:bg-[var(--color-accent)] flex flex-col items-start gap-4"
                        >
                            ...
                            {/* Affordance */}
                            <span className="inline-flex items-center gap-2 text-xs omx-label font-bold uppercase tracking-[0.08em] text-[var(--color-primary-ink)] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                View papers
