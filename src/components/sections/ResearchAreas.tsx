...
const areas = [
    {
        ...
        icon: <LuCpu className="w-7 h-7 text-blue-500" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuBrainCircuit className="w-7 h-7 text-emerald-500" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuNetwork className="w-7 h-7 text-indigo-500" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuShieldAlert className="w-7 h-7 text-rose-500" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuActivity className="w-7 h-7 text-amber-500" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuUsers className="w-7 h-7 text-violet-500" strokeWidth={2} />,
    },
];
