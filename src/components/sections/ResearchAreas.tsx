...
const areas = [
    {
        ...
        icon: <LuCpu className="w-7 h-7 text-[#22D3EE]" strokeWidth={2} />,
    },
    {
        ...
        icon: <LuBrainCircuit className="w-7 h-7 text-[#38BDF8]" strokeWidth={2} />,
    },
    {
    ...
    },
    {
        ...
        icon: <LuShieldAlert className="w-7 h-7 text-[#818CF8]" strokeWidth={2} />,
    },
    {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {areas.map((area) => (
                        ...
                        >
                            ...
                            {/* Affordance */}
                            <span className="inline-flex items-center gap-2 text-xs font-mono font-bold uppercase tracking-widest text-[var(--color-primary-ink)] opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                View papers
