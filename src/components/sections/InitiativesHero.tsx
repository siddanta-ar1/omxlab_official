...
const floatingIcons = [
    { id: 1, Icon: LuHeartHandshake, color: 'text-[#E11D48]', pos: 'top-[15%] left-[4%]', size: 'text-5xl', animation: 'animate-float' },
    { id: 2, Icon: LuGlobe, color: 'text-[#0284C7]', pos: 'top-[35%] left-[6%]', size: 'text-4xl', animation: 'animate-float-delayed' },
    { id: 3, Icon: LuSprout, color: 'text-[#16A34A]', pos: 'bottom-[30%] left-[5%]', size: 'text-5xl', animation: 'animate-float-slow' },
    { id: 4, Icon: LuGraduationCap, color: 'text-[#9333EA]', pos: 'top-[20%] right-[5%]', size: 'text-5xl', animation: 'animate-float-delayed' },
    { id: 5, Icon: LuUsers, color: 'text-[#0284C7]', pos: 'top-[45%] right-[7%]', size: 'text-4xl', animation: 'animate-float' },
    { id: 6, Icon: LuRocket, color: 'text-[#DB2777]', pos: 'bottom-[25%] right-[5%]', size: 'text-4xl', animation: 'animate-float-slow' },
];
...
const mobileFloatingIcons = [
    ...
    { id: 2, Icon: LuUsers, color: 'text-[#0284C7]', pos: 'top-[30%] right-[4%]', size: 'text-3xl', animation: 'animate-float-fast-delayed' },
