...
const icons = {
    review: { Icon: LuCircleCheck, color: 'text-emerald-500' },
    compass: { Icon: LuCompass, color: 'text-indigo-500' },
    clock: { Icon: LuClock, color: 'text-amber-500' },
    book: { Icon: LuBookOpen, color: 'text-violet-500' },
    flask: { Icon: LuFlaskConical, color: 'text-blue-500' },
    heart: { Icon: LuHeart, color: 'text-rose-500' },
};
